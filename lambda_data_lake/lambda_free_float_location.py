...
def lambda_handler(event, context):
    ...
    # Add the timestamp as additional column to vehicle data
    ...
    providers = ['bird-zurich-escooter', 'tier', 'voiscooters.com']
    ...
    # Change projection system to match the one of vehicle data
    ...
    for idx in range(map_df.shape[0]):
        # For every address, find if they reside within a neigburhood
